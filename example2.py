...
# build our nn
nn = NeuralNetwork()
nn.add_layer(FullyConnectedLayer(neurons=10, activation='relu', dropout=0))
nn.add_layer(FullyConnectedLayer(neurons=3, activation='softmax'))

print('\n')
print('Training a Multi-Layer-Perceptron...')
# fit our nn
nn.fit(x, y, batch_size=141, epochs=100, learning_rate=.001, optimizer='rmsprop', loss='logloss', l2=0, early_stopping=False)
